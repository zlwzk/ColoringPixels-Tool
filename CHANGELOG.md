...
- **一键安装器**（`ColoringPixelsCheat-Setup.exe`，单文件、免安装）
...
[1.1.0]: https://github.com/zlwzk/ColoringPixelsCheat/releases/tag/v1.1.0
[1.0.0]: https://github.com/zlwzk/ColoringPixelsCheat/releases/tag/v1.0.0
